...
#include <observatory/util/BenchmarkPhaseFactory.h>
...
public:
    ...
    InitializationPhase(const InitializationPhase &other) = default;
    ...
    BENCHMARK_PHASE_IMPLEMENT_CLONE(Observatory::InitializationPhase)

    Result::Status execute() override;
